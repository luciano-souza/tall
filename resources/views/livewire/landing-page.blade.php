<div class="flex flex-col bg-indigo-900 w-full h-screen"
    ...
    <nav class="flex pt-5 justify-between container px-4 mx-auto text-indigo-200">
    ...
    <div class="flex container px-4 mx-auto items-center h-full">
        <div class="flex flex-col w-1/3 items-start">
            ...
            <p class="text-indigo-200 text-xl mb-10">We are just checking the
                <span class="font-bold underline">TALL</span>
                stack. Would you mind subscribing?
            </p>
            <x-button class="py-3 px-8 bg-red-500 hover:bg-red-600" @click="showSubscribe = true">
                Subscribe
            </x-button>
        </div>
    </div>
